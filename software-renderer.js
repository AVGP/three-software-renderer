...
module.exports = function ( parameters ) {
	...
	var canvas = {width: 0, height: 0}; /*parameters.canvas !== undefined
			 ? parameters.canvas
...
*/
		imagedata = {data: new Uint8ClampedArray(canvas.width * canvas.height * 4), width: canvas.width, height: canvas.height}; //new ImageData(canvasWidth, canvasHeight); //context.getImageData( 0, 0, canvasWidth, canvasHeight );
		data = imagedata.data;
